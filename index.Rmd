...
Mainly including One/two sample proportion test, one/two sample continous test and one/two sample survival test. Each one contains three test methods: test for equality, test for equivalence and test for superiority/non-inferiority.
...
author: Bihui Sun
        (Summer Intern, Department of Biostatistics, HuaJia Biomedical Intelligence, Shenzhen, China)